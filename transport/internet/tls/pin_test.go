...
func TestCalculatePEMLeafCertSHA256Hash(t *testing.T) {
	const Single = `-----BEGIN CERTIFICATE-----
MIINWzCCC0OgAwIBAgITMwK6ajqdrV0tahuIrQAAArpqOjANBgkqhkiG9w0BAQwF
ADBdMQswCQYDVQQGEwJVUzEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
MS4wLAYDVQQDEyVNaWNyb3NvZnQgQXp1cmUgUlNBIFRMUyBJc3N1aW5nIENBIDA0
...
`
	t.Run("calculate_leaf_hash", func(t *testing.T) {
		hash, err := CalculatePEMLeafCertSHA256Hash([]byte(Single))
		assert.NoError(t, err)
		assert.Equal(t, "ae243d668ec9c7f74a0dcd1ad21c6676b4efe30c39728934b362093af886bf77", hash)
	})
}

func TestGenerateCertHashWithBytes(t *testing.T) {
	t.Run("bytes_input", func(t *testing.T) {
		data := []byte("test certificate data")
		hash := GenerateCertHash(data)
